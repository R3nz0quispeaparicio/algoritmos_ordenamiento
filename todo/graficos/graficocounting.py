...
ax.set_title('Comparación de tiempos de procesamiento counting sort')
ax.legend()
valores_y = [0.1,0.2,0.3,0.4]
...
fig.savefig('graficocounting.pdf', bbox_inches='tight', pad_inches=0.3, dpi=900)
